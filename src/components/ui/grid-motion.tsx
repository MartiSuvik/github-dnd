              ...
              {[...Array(6)].map((_, itemIndex) => {
                ...
                return (
                  <div key={itemIndex} className="relative">
                    <div
                      // If content is an image, make it clickable to expand
                      onClick={() => {
                        if (typeof content === 'string' && content.startsWith('http')) {
                          setExpandedImage(content);
                        }
                      }}
                      className="relative h-full w-full overflow-hidden bg-muted flex items-center justify-center text-foreground text-base sm:text-xl group cursor-pointer"
                    >
