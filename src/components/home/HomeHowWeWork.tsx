    ...
    <section id="italian-craftsmanship" className="py-12 md:py-20 bg-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          {/* Content Section with staggered animations (Left Section on desktop, Bottom Section on mobile) */}
          ...
          {/* Video Section with animation (Right Section on desktop, Top Section on mobile) */}
          <AnimatedSection
            delay={200}
